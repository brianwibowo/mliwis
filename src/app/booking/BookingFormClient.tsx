...
Mohon bantuan untuk melakukan verifikasi pemesanan kami. Terima kasih!`
  ...
  return (
    <div style={{ background: 'var(--color-surface)', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      {/* Main Form Section */}
      <section id="form-section" style={{ padding: '60px 0 80px', backgroundColor: 'var(--color-surface-alt)', scrollMarginTop: '60px' }}>
      ...
      {/* Calendar Section (Placed below Panduan & Form for clear UI flow) */}
      <section id="calendar-section" style={{ padding: '60px 0 80px', backgroundColor: 'var(--color-surface)', scrollMarginTop: '60px' }}>
        <div className="landing-container">
          <div className="landing-section-header" style={{ textAlign: 'center', marginBottom: '48px' }}>
            <span className="landing-tagline" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '6px 16px', borderRadius: '30px', backgroundColor: 'var(--color-primary-50)', color: 'var(--color-primary-600)', fontSize: '0.85rem', fontWeight: 600, marginBottom: '12px' }}>
              <Calendar size={14} />
            ...
            <p style={{ color: 'var(--color-text-muted)', fontSize: '1rem', maxWidth: '600px', margin: '12px auto 0', lineHeight: 1.5 }}>
              Periksa kalender di bawah untuk melihat rincian tanggal acara yang sudah terisi atau disetujui oleh pengelola.
            </p>
          </div>
      ...
      <section style={{ padding: '0 0 80px', backgroundColor: 'var(--color-surface)' }}>
        <div className="landing-container">
          <div id="cek-status-section" style={{ maxWidth: '650px', margin: '0 auto', scrollMarginTop: '100px' }}>
            <div 
              className="card" 
              style={{ 
                border: '1px solid var(--color-border-subtle)', 

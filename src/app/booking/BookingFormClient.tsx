...
import { Waves, Send, Copy, CheckCircle, Tent, TreePine, Building, Camera, Store, Info, Phone, MapPin, ChevronRight } from 'lucide-react'
...
const slugMap: Record<string, string> = {
  ...
  'payung-pantai': 'Area Camping Ground',
  'musola': 'Pendopo/Aula Terbuka',
  'aneka-kuliner': 'Area UMKM',
  'pendopo': 'Pendopo/Aula Terbuka',
  'sewa-tikar': 'Area Camping Ground',
  'kuda-pantai': 'Area Outbound',
  'gazebo': 'Area Camping Ground',
  'sewa-ayunan': 'Area Camping Ground',
  'parkir': 'Area UMKM',
  'kolam-renang-anak': 'Area Outbound',
  'atv-pantai': 'Area Outbound',
